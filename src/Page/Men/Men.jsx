...
const Men = () => {
   ...
   const menShoes = products?.filter(shoe => shoe.man === 'men');
   ...
   return (
      <div className="container mx-auto">
         <Helmet>
                         <title>BdHub || Mens</title>
                     </Helmet>
         {/* Cover কম্পোনেন্টকে আরও ফ্লেক্সিবল করা হয়েছে */}
         <Cover heading={"Men's Collection"} subHeading={"Find your perfect pair from our exclusive men's collection."} image={"https://images.unsplash.com/photo-1549298916-b41d501d3772?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"}>
